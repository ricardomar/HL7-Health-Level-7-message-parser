...
if size(find(posicao==0),2)~=0
    if strcmp(campos(1,1),'PID')==1
        if(size(find(posicao==3),2)~=0)
            ...
            mensagemStatus=strvcat(mensagemStatus,'PID campo 3: Campo Obrigatório');
            erroTipo1=1;
        end
    else
        mensagemStatus=strvcat(mensagemStatus,'PID ID não reconhecido');
        erroTipo1=1;
    end
else
...
if erroTipo1==0
    ...
    if(size(find(posicao==7),2)~=0)
        if verificaData(campos(1,find(posicao==7)))==1            
            if compara_data(campos(1,find(posicao==7)),converte_data())==0;
                mensagemStatus=strvcat(mensagemStatus,'PIN campo 7: Data com estrutura correcta  Aviso- A data que introduziu é posterior à data actual!');
                erroTipo2=1;
            end                        
        else
    ...
    if(size(find(posicao==8),2)~=0)
        if PID_8(campos(1,find(posicao==8)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 8: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==10),2)~=0)
        if PID_10(campos(1,find(posicao==10)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 10: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==15),2)~=0)
        if PID_15(campos(1,find(posicao==15)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 15: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==16),2)~=0)
        if PID_16(campos(1,find(posicao==16)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 16: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==17),2)~=0)
        if PID_17(campos(1,find(posicao==17)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 17: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==22),2)~=0)
        if PID_22(campos(1,find(posicao==22)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 22: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==24),2)~=0)
        if PID_24(campos(1,find(posicao==24)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 24: O valor do campo não é válido');
            erroTipo2=1;
        end
    end
    ...
    if(size(find(posicao==27),2)~=0)                
        if PID_27(campos(1,find(posicao==27)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 27: O valor do campo não é válido');
            erroTipo2=1;
        end
    end 
    ...
    if(size(find(posicao==29),2)~=0)
        if verificaData(campos(1,find(posicao==29)))==1            
            if compara_data(campos(1,find(posicao==29)),converte_data())==0;
                mensagemStatus=strvcat(mensagemStatus,'PIN campo 29: Data com estrutura correcta  Aviso- A data que introduziu é posterior à data actual!');
                erroTipo2=1;
            end                        
        else
    ...
    if(size(find(posicao==30),2)~=0)
        if PID_30(campos(1,find(posicao==30)))==0
            mensagemStatus=strvcat(mensagemStatus,'PID campo 30: O valor do campo não é válido');
            erroTipo2=1;
        end
    end     
